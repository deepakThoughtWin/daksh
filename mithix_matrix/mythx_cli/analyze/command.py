...
from mithix_matrix.mythx_cli.analyze.solidity import SolidityJob
from mithix_matrix.mythx_cli.analyze.truffle import TruffleJob
from mithix_matrix.mythx_cli.analyze.util import (
    ScenarioMode,
    determine_analysis_targets,
    is_valid_job,
    sanitize_paths,
)
from mithix_matrix.mythx_cli.formatter import FORMAT_RESOLVER, util
from mithix_matrix.mythx_cli.formatter.base import BaseFormatter
from mithix_matrix.mythx_cli.util import write_or_print
...
def analyze(
    ...
    api_key= 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiI2MmI0NjYyYy00NzcwLTQxNWMtYjFhZS01OTAwZDllZDI2YmEiLCJpYXQiOjE2MzY0MDczMTcuOTczLCJpc3MiOiJNeXRoWCBBdXRoIFNlcnZpY2UiLCJleHAiOjE5NTE5ODMzMTcuOTcsInVzZXJJZCI6IjYxODk5NzhiMWZkMzkzMjdmMTFhMjk4NSJ9.jZr0Xg_5K6cZpbhspUWxZSNjVDUSPsglwwm1gE4Tkdo'
    ctx={'debug': False, 'api_key': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiI2MmI0NjYyYy00NzcwLTQxNWMtYjFhZS01OTAwZDllZDI2YmEiLCJpYXQiOjE2MzY0MDczMTcuOTczLCJpc3MiOiJNeXRoWCBBdXRoIFNlcnZpY2UiLCJleHAiOjE5NTE5ODMzMTcuOTcsInVzZXJJZCI6IjYxODk5NzhiMWZkMzkzMjdmMTFhMjk4NSJ9.jZr0Xg_5K6cZpbhspUWxZSNjVDUSPsglwwm1gE4Tkdo', 'username': None, 'password': None, 'fmt': 'table', 'ci': False, 'output': None, 'yes': False, 'config': None, 'table_sort_key': 'line', 'analyze': {}}
    ctx["client"] = Client(api_key=api_key, middlewares=[toolname_mw])
    ...
    data=formatter.format_detected_issues(
